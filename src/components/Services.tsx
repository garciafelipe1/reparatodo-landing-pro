  ...
  return (
    <section className="py-16 bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-75">
        ...
        <div className="absolute top-6 right-8 w-1.5 h-1.5 bg-primary rounded-full"></div>
        <div className="absolute top-10 right-4 w-1 h-1 bg-primary rounded-full"></div>
        <div className="absolute top-14 right-16 w-2 h-2 bg-primary rounded-full"></div>
        ...
        <div className="absolute top-30 right-2 w-2 h-2 bg-primary rounded-full"></div>
        <div className="absolute top-34 right-14 w-1.5 h-1.5 bg-primary rounded-full"></div>
        <div className="absolute top-38 right-8 w-1 h-1 bg-primary rounded-full"></div>
        ...
        <div className="absolute bottom-6 right-10 w-1 h-1 bg-primary rounded-full"></div>
        <div className="absolute bottom-10 right-18 w-1.5 h-1.5 bg-primary rounded-full"></div>
        <div className="absolute bottom-14 right-4 w-2 h-2 bg-primary rounded-full"></div>
        <div className="absolute bottom-18 right-14 w-1 h-1 bg-primary rounded-full"></div>
        <div className="absolute bottom-22 right-22 w-1.5 h-1.5 bg-primary rounded-full"></div>
      </div>
